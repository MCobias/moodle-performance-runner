...
if (!empty($_GET['threadgroupname']) && array_key_exists($_GET['threadgroupname'], $runs)) {
    $threadgroupname = $_GET['threadgroupname'];
}
...
echo '<link rel="stylesheet" type="text/css" href="css/jmeter.css" />';
echo "<script type='text/javascript' src='js/jmeter.js'></script>";
echo "</head>";
echo "<body>";

display_run_selector($runs, $before, $after, $threadgroupname, array('w' => $width, 'h' => $height), $organiseby, $mostcommononly);
